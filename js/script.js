...
function getSubTotal() {
    ...
    $("#shopping-cart .price").each(function(){
        value = $(this).text().match(/\d+/); 
        value = parseFloat(value);
        sub += value;
        sub = Math.round(sub*100)/100;
    });
    $("#shopping-cart #subtotal .value").text(sub);
    return sub;
...
$(document).ready(function() {
    ...
    $("#recipecontainer ul li a.title").click(function(event){
    ...
    $(".cartadd").click(function(event){
        ...
        var html ="<tr><td><a href='#' class='remove'>Remove</a></td><td>";
        html += $(this).siblings(".title").text();        
        html += "</td><td class='price'>";
        html += $(this).siblings(".price").text();
        html += "</td></tr>";
        
        $("#shopping-cart table").append(html).each(function() {
                        
            $("#shopping-cart .remove").click(function(event){
                event.preventDefault();
                $(this).closest("tr").remove();

                getSubTotal();            

                count = $("#shopping-cart tr").size(); 
    ...
    $(".checkout").click(function(event){
        ...
        if(getSubTotal() < 1) {
            ...
            var order = $("#shopping-cart").html();
            $("#mail-form #order").val(order);
            $("#mail-form").submit();
            ...
            var loadUrl = "404.php";
            alert(order);
            $.post( loadUrl, {order: order},
            function(responseText){  
                $("#paypal-checkout input[name='amount']").val(amount);            
    ...
    $("#shopping-cart .continue").click(function(event){    
        event.preventDefault();
